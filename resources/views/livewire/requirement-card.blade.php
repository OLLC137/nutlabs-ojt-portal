    ...
    <div class="card">
        <div class="card-body">
            ...
            <form wire:submit.prevent="uploadFile">
                <x-template.input type="file" text="" wire:model="requirementFile" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png"></x-template.input>
        ...
        <div class="pb-4 px-3 d-flex">
            <button wire:click="submit" class="col btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#submitModal">Submit</button>
        </div>
        @endif
    </div>
</div>
