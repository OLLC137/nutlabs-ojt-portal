    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            @role(SADM)
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basics">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('view-company-page') }}">Company
                                    List</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('add-company-page') }}">Add Company</a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            @role(COMPANY)
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('manage-job-list') }}">
                        <x-template.icon class="menu-icon"> animation </x-template.icon>
                        <span class="menu-title">Manage Job Listings</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('view-company-page') }}">Company
                                    List</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('add-company-page') }}">Add
                                    Company</a></li>
                        </ul>
                    </div>
                </li>
            ...
            @role(ADM)
                ...
                <li class="nav-item sidebar-actions">
                    <span class="nav-link">
                        ...
                        <x-template.button color="primary" variant="gradient" size="lg" :block="true"
                            class="mt-4"> + Add a project </x-template.button>
                        <div class="mt-4">
                            <div class="border-bottom">
